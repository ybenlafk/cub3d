...
/*   Updated: 2023/05/16 14:04:43 by ybenlafk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void ft_hook(void* param)
{
	...
	if (data->p.px < 0 || data->p.py < 0 || data->p.px > WIDTH || data->p.py > HEIGHT)
		data->p.px = 0;
	if (data->p.py < 0 || data->p.py > HEIGHT)
		data->p.py = 0;
	if (mlx_is_key_down(data->mlx, MLX_KEY_S))
	{
		data->p.px -= data->p.pdx;
		data->p.py -= data->p.pdy;
	}
	...
	{
		data->p.px += data->p.pdy;
		data->p.py -= data->p.pdx;
	}
